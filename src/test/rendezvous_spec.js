...
var rv = require("../app/rendezvous");


function async(x) {
  return function(cb) { setTimeout(function () { cb(x); }, x) };
}

function asyncError(delay, msg) {
  return function(cb) { setTimeout(function () { cb(new Error(msg)); }, delay) };
}


describe("module countdown : ", function () {
